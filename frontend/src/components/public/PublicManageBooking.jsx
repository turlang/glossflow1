  ...
  return (
    <main className="manage-booking-page" style={{ '--primary': salon?.primaryColor || '#C49A6C' }}>
      <section className="manage-booking-card">
        ...
        {!loading && error && !appointment && <div className="manage-booking-state is-error"><strong>Não foi possível abrir o agendamento.</strong><span>{error}</span></div>}
