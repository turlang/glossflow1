...
const clients = [
  { id: '1', name: 'Carla', phone: '11999999999', email: '', tags: ['BIRTHDAY', 'FREQUENT'], primarySegment: 'BIRTHDAY', reason: 'Aniversário em 2 dias', marketingAllowed: true, daysSinceLastVisit: 10 },
  { id: '2', name: 'Bianca', phone: '11888888888', email: 'bia@example.com', tags: ['INACTIVE_120'], primarySegment: 'INACTIVE_120', reason: 'Sem atendimento há 130 dias', marketingAllowed: false, daysSinceLastVisit: 130 }
];

describe('crm retention utils', () => {
  it('filtra por segmento sem perder clientes com múltiplas tags', () => {
  ...
  it('monta KPIs de reativação com resumo do backend', () => {
    ...
    expect(kpis.find((item) => item.label === 'Reativação').value).toContain('25');
  });

  it('traduz recência e prioridade para a interface', () => {
