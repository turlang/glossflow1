  ...
  return (
    <main className="capability-page">
      ...
      <style>{`
        ...
        @media(max-width:820px){.capability-header{display:grid}.capability-grid{grid-template-columns:1fr}.capability-services{grid-template-columns:1fr}.capability-footer{align-items:stretch;flex-direction:column}.capability-footer .primary{width:100%}}
      `}</style>
    </main>
  );
}
