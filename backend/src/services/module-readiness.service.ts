...
const MODULE_READINESS: Record<SalonModule, ModuleReadiness> = {
  ...
  MARKETING: { status: 'EVOLUTION_REQUIRED', maturity: 70, summary: 'Campanhas, segmentos, cupons e solicitações de avaliação implementados.', nextAction: 'Adicionar scheduler/fila real, gatilhos automáticos e métricas de entrega/conversão.' },
  ...
  MULTIUNIDADE: { status: 'EVOLUTION_REQUIRED', maturity: 68, summary: 'Organizações e vínculo seguro por convite/aceite entre tenants implementados.', nextAction: 'Construir políticas corporativas explícitas antes de compartilhar CRM, estoque ou financeiro entre unidades.' },
  ...
  FINANCEIRO_ADV: { status: 'EVOLUTION_REQUIRED', maturity: 75, summary: 'Caixa, centros de custo, contas, liquidação e conciliação implementados; ciclo fiscal preparado.', nextAction: 'Homologar financeiro avançado e integrar provider fiscal/NFS-e real antes de emissão.' }
};
